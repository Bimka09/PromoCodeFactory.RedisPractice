...
namespace Otus.Teaching.Pcf.GivingToCustomer.WebHost
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddHttpClient<IPreferencesFromDistributedCache, PreferencesFromDistributedCache>(c =>
            {
                c.BaseAddress = new Uri(Configuration["IntegrationSettings:PreferencesFromDistributedCacheApiUrl"]);
            });
