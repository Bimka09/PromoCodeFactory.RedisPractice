 ...
 namespace Otus.Teaching.Pcf.ReceivingFromPartner.WebHost.Controllers
{
        ...
        : ControllerBase
    {
        ...
        //private readonly IRepository<Preference> _preferencesfromdistributedcache;
        ...
        public PartnersController(IRepository<Partner> partnersRepository,
            IPreferencesFromDistributedCache preferencesRepository, 
            ...
            IAdministrationGateway administrationGateway)
        {
            ...
            _preferencesFromDistributedCache = preferencesRepository;
            ...
            ReceivingPromoCodeRequest request)
        {
            ...
            var preference = await _preferencesFromDistributedCache.GetByIdAsync(request.PreferenceId);
